...
archivos = [
    "output/output_000E04t02.dat",
    "output/output_001E04t02.dat",
    "output/output_005E04t02.dat",
    "output/output_010E04t02.dat",
    "output/output_015E04t02.dat"
]
...
plt.ylabel('Valor')
plt.title('Gráfico de los archivos de salida')
plt.legend()
plt.grid(True)
